...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/ReverseScale/spec_bin_dev/tree/main/TestPodKit'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'ReverseScale@iCloud.com' => 'ReverseScale@iCloud.com' }
  s.source           = { :git => 'https://github.com/ReverseScale/spec_bin_dev/tree/main/TestPodKit', :tag => s.version.to_s }
